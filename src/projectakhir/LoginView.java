...
public class LoginView extends javax.swing.JFrame {
    ...
    void CheckData(String usr, String pswd){
        ...
        String user_ = txtusername.getText();
        String pswd_ = txtpassword.getText();
        try {
            RandomAccessFile raf = new RandomAccessFile(f+"\\logins.txt", "rw");
            for(int i=0;i<ln;i+=4){
                String User = raf.readLine().substring(9);
                String Pswd = raf.readLine().substring(9);
                if(usr.equals(user_)& pswd.equals(pswd_)){
                    Utama U = new Utama();
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        createFolder();
        CheckData(txtusername.getText(), txtpassword.getText());
